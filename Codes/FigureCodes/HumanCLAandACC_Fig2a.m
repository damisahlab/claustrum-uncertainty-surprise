...
load(fullfile(data_path, 'Fig2a_Venn.mat'))
...
%2 is hit
%3 is miss
appSpecIndx=Fig2a_Venn{1,2};
hitSpecIndx=Fig2a_Venn{2,2};
missSpecIndx=Fig2a_Venn{3,2};
appHitIdx=Fig2a_Venn{4,2};
appMissIdx=Fig2a_Venn{5,2};
hitMissIdx=Fig2a_Venn{6,2};
appHitMissIdx=Fig2a_Venn{7,2};
...
fontsize(12,'pixels')
sgt= sgtitle('Figure 2a. Distribution of claustrum neurons');
sgt.FontSize = 13;
